...
def crear_manual_usuario():
    ...
    if os.path.exists(dashboard_path):
        try:
            dashboard = Image(dashboard_path, width=12*cm, height=8*cm)
    ...
    <b>Desarrollado par:</b> Unidad II - Finanzas Corporativas
    """
    ...
    modulo_img = os.path.join(images_dir, 'modulo_a_captura.png')
