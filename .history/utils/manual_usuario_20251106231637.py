...
def crear_manual_usuario():
    ...
    # Índice ejecutivo - formato de lista mejorado
    content.append(Paragraph("📋 ÍNDICE EJECUTIVO", subtitle_style))
    content.append(Spacer(1, 20))

    indice_items = [
        "🎯 <b>Capítulo 1:</b> Introducción y Beneficios Clave ........................... 3",
        "🚀 <b>Capítulo 2:</b> Primeros Pasos - Comienza Tu Viaje ..................... 6",
        "👤 <b>Capítulo 3:</b> Sistema de Usuarios y Perfiles ........................ 9",
        "💼 <b>Capítulo 4:</b> Módulo A: Crecimiento de Cartera ..................... 12",
        "🏖️ <b>Capítulo 5:</b> Módulo B: Proyección de Jubilación .................. 17",
        "📈 <b>Capítulo 6:</b> Módulo C: Valoración de Bonos ........................ 22",
        "🎲 <b>Capítulo 7:</b> Análisis de Escenarios Avanzados ..................... 27",
        "📊 <b>Capítulo 8:</b> Sistema de Logros y Gamificación ..................... 32",
        "👥 <b>Capítulo 9:</b> Comparación Social Inteligente ....................... 37",
        "🛒 <b>Capítulo 10:</b> Marketplace de Templates ............................. 41",
        "📄 <b>Capítulo 11:</b> Reportes Profesionales en PDF ........................ 45",
        "🔧 <b>Capítulo 12:</b> Soporte y Solución de Problemas ..................... 49",
        "📚 <b>Capítulo 13:</b> Glosario Ejecutivo ................................... 53",
        "📞 <b>Anexos:</b> Información de Contacto y Recursos Adicionales .......... 57"
    ]
    ...
    es tu compañero estratégico en el viaje hacia la libertad financiera.<br/><br/>

    <b>¿Sabías que?</b> El 78% de las personas mayores de 65 años dependen únicamente de su pensión de jubilación
    para cubrir sus gastos básicos. Sin una planificación adecuada, muchos enfrentan dificultades económicas
    que afectan su calidad de vida. Nuestra plataforma está diseñada para cambiar esta realidad.
    """

    content.append(Paragraph(intro_text, normal_style))

    content.append(Paragraph("🎯 <b>¿QUÉ ES TU RETIRO SEGURO?</b>", subsection_style))

    what_is_text = """
    Tu Retiro Seguro es una plataforma tecnológica avanzada que combina:<br/>
    • <b>Matemáticas Financieras Avanzadas:</b> Algoritmos basados en conceptos de valor del dinero en el tiempo<br/>
    • <b>Inteligencia Artificial:</b> Análisis predictivo para escenarios futuros<br/>
    • <b>Experiencia de Usuario Premium:</b> Interfaz intuitiva sin conocimientos técnicos previos<br/>
    • <b>Gamificación Educativa:</b> Aprendizaje financiero a través de recompensas y logros<br/>
    • <b>Comunidad Interactiva:</b> Aprendizaje colaborativo con otros planificadores financieros
    """

    content.append(Paragraph(what_is_text, normal_style))

    content.append(Paragraph("🌟 <b>BENEFICIOS TRANSFORMADORES QUE CAMBIARÁN TU VIDA:</b>", highlight_style))

    benefits = [
        "💡 <b>Visión Clara del Futuro:</b> Conoce exactamente cuánto capital acumularás y cómo crecerá tu dinero con el tiempo. Elimina la incertidumbre y toma decisiones basadas en datos reales.",
        "🎯 <b>Decisiones Inteligentes:</b> Compara escenarios ilimitados para optimizar tu estrategia de inversión. ¿Qué pasa si invierto más? ¿Y si jubilo antes?",
        "⏰ <b>Ahorro de Tiempo:</b> Calcula en segundos lo que antes tomaba horas de análisis complejo. Dedica tu tiempo a vivir, no a calcular.",
        "📈 <b>Maximización de Rendimientos:</b> Descubre las mejores oportunidades de inversión para tu perfil. Cada dólar cuenta cuando se invierte inteligentemente.",
        "🛡️ <b>Seguridad Financiera:</b> Planifica tu jubilación con confianza y elimina la incertidumbre. Duerme tranquilo sabiendo que tu futuro está asegurado.",
        "🎮 <b>Experiencia Gamificada:</b> Aprende finanzas mientras te diviertes con nuestro sistema de logros. ¡Cada paso te acerca a la libertad financiera!",
        "👥 <b>Aprendizaje Social:</b> Comparte conocimientos y aprende de la comunidad financiera. El conocimiento colectivo acelera tu progreso.",
        "📱 <b>Acceso Universal:</b> Usa desde cualquier dispositivo, en cualquier momento y lugar. Tu planificación financiera siempre a mano."
    ]
    ...
    content.append(Paragraph("📊 <b>CASOS DE ÉXITO REALES:</b>", subsection_style))

    case_studies = """
    <b>Ejemplo 1 - María, 35 años:</b> "Antes usaba hojas de cálculo complicadas. Ahora veo exactamente
    cuánto necesito ahorrar mensualmente para jubilarme a los 55. ¡He aumentado mis aportes en 30%!"<br/><br/>

    <b>Ejemplo 2 - Carlos, 42 años:</b> "El módulo de comparación me mostró que mi estrategia actual
    me llevaría 25 años más de lo planeado. Cambié mi enfoque y ahora ahorro 40% más."<br/><br/>

    <b>Ejemplo 3 - Ana, 28 años:</b> "Los logros me mantienen motivada. Cada vez que completo una simulación,
    siento que estoy más cerca de mi libertad financiera."
    """

    content.append(Paragraph(case_studies, normal_style))

    content.append(Spacer(1, 20))

    value_prop = """
    <b>¿Por qué elegir Tu Retiro Seguro sobre otras opciones?</b><br/><br/>

    <b>Vs. Hojas de Cálculo Tradicionales:</b> Automatiza cálculos complejos que toman horas en Excel<br/>
    <b>Vs. Asesores Financieros:</b> Acceso 24/7 a análisis profesionales sin costos recurrentes<br/>
    <b>Vs. Apps Básicas:</b> Modelos matemáticos avanzados con escenarios probabilísticos<br/>
    <b>Vs. Cursos Teóricos:</b> Aprendizaje práctico con aplicación inmediata a tu situación real<br/><br/>
    ...
    # Diseño mejorado para campos - formato de lista vertical más atractiva
    campos_a_items = [
    ...
    for campo in campos_a_items:
        content.append(Paragraph(campo, benefit_style))
    ...
    glossary_terms = [
        "💰 <b>TEA (Tasa Efectiva Anual):</b> Rendimiento real anual de una inversión, considerando capitalización",
        "🎪 <b>Interés Compuesto:</b> 'Interés sobre interés' - el secreto de la riqueza a largo plazo",
        "⏰ <b>Valor del Dinero en el Tiempo:</b> Un dólar hoy vale más que un dólar mañana",
        "💵 <b>Valor Presente:</b> Conversión de valores futuros a su equivalente actual",
        "🏷️ <b>Valor Nominal:</b> Valor facial o de vencimiento de un instrumento financiero",
        "🎟️ <b>Tasa Cupón:</b> Interés que pagan los bonos periódicamente a sus tenedores",
        "📊 <b>Duration:</b> Medida de la sensibilidad de un bono a cambios en tasas de interés",
        "🏦 <b>Riesgo de Crédito:</b> Probabilidad de que el emisor no cumpla con sus pagos",
        "📈 <b>Rentabilidad Esperada:</b> Rendimiento promedio que anticipas de una inversión",
        "🛡️ <b>Diversificación:</b> Estrategia de no poner todos los huevos en una canasta"
    ]

    for term in glossary_terms:
        content.append(Paragraph(term, benefit_style))

    content.append(Spacer(1, 30))

    # Cierre inspiracional
    closing_text = """
    <b>¡Tu Futuro Financiero Comienza Hoy!</b><br/><br/>
    ...
    <b>¡Que tu viaje hacia la prosperidad financiera sea extraordinario!</b>
    """

    content.append(Paragraph(closing_text, highlight_style))

    # Información de contacto
    contact_info = """
    <br/><b>Información de Contacto:</b><br/>
    📧 soporte@turetiroseguro.com<br/>
    🌐 www.turetiroseguro.com<br/>
    📱 Aplicación web disponible 24/7
    """
