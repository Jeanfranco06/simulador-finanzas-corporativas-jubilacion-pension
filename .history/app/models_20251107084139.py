...
def calcular_jubilacion(datos):
    ...
    if tipo_retiro == 'pension':
        ...
        # Paso 1: Obtener capital acumulado final
        # Paso 2: Determinar la tasa efectiva anual (TEA) para dividendos
        # Se toma la TEA durante el retiro y se considera la proporción que el fondo reparte como dividendos (la mitad de la TEA)

        # Paso 3: Calcular dividendos anuales
        # Dividendos anuales = Capital acumulado × (TEA / 2)
        dividendos_anuales = capital_final * (tea_retiro / 2)

        # Paso 4: Convertir dividendos anuales a mensual
