...
def calcular_escenario():
    ...
    try:
        ...
        print(f"Error in comparar_estrategias: {str(e)}")
        print(f"Traceback: {error_details}")
        return jsonify({'success': False, 'error': f'Error al comparar estrategias: {str(e)}'})
...
@main.route('/plantillas')
def templates_marketplace():
    """Templates marketplace page"""
    return render_template('user/templates_marketplace.html')
